...
rMSIfragment:::plot_figure2(pks_neg,res.neg.20ppm,gt_neg,"S",steps = 20,label="_adduct_score",topN = T)
...
rMSIfragment:::plot_figure2(pks_pos,res.pos.5ppm,gt_pos,"S",steps = 20,label="_adduct_score",topN = T)
